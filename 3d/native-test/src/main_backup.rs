...
command_list.SetPipelineState(&graphics_pipeline);
...
let present_barrier = D3D12_RESOURCE_BARRIER {
    Type: D3D12_RESOURCE_BARRIER_TYPE_TRANSITION,
    Flags: Default::default(),
...
println!("✅ Render target transitioned back to PRESENT");
